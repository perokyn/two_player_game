        ...
        {cards.map((card) => {
          ...
          return (
            <div
              ...
              style={{
                // Maintain a square shape by default so the grid doesn't collapse
                aspectRatio: isCardFlipped ? "auto" : "1/1",
                // When flipped, we give it a minimum height to push the grid down
                minHeight: isCardFlipped ? "200px" : "auto",
                zIndex: isCardFlipped ? 50 : 1,
                opacity: isMatched ? 0.3 : 1,
                // Ensure the item takes up at least the space of a normal card
                width: "100%",
              }}
            >
              <GameCard
...
//               // Make sure that transform also works on other users grid
//               if (r1 === r2) {
